...
- (NSInteger)heightForRow:(NSInteger)row inSection:(NSInteger)section {
    ...
    switch (section) {
        ...
        case 1:                 // Transfer
            switch (row) {
                ...
                case 3:         // Target Sum
                    break;
                default:
                    @throw [NSException exceptionWithName:@"YYGGetCreditEditViewModel heightForRow:inSection: fails." reason:@"Unknown row number." userInfo:nil];
            }
            break;
        case 2:                 // Comment
            height = 70;
        ...
        case 3:                 // Actions
            ...
            break;
        default:
            @throw [NSException exceptionWithName:@"YYGGetCreditEditViewModel heightForRow:inSection: fails." reason:@"Unknown section number." userInfo:nil];
    }
